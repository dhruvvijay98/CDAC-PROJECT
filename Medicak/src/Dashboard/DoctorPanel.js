...
const DoctorPanel = ({ userData }) => {
    ...
    // Automatically set the doctor's name from userData and make it uneditable
            ...
            <form onSubmit={handleSubmit} className="doctor-panel-form">
                ...
                <div className="form-group">
                    ...
                    <input 
                        type="date" 
                        value={diagnosedDate}
                        onChange={(e) => setDiagnosedDate(e.target.value)}  max={getCurrentDate()}
                        required
                    />
                </div>
                <div className="form-group">
                    ...
                    <input 
                        type="text" 
                        value={doctorName}
                        readOnly // This makes the field uneditable
                    />
                </div>
